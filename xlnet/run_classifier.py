...
model_dir = '/home/xsq/model/chinese_xlnet_mid_L-24_H-768_A-12/'


# Model
flags.DEFINE_string("model_config_path", default=model_dir + 'xlnet_config.json',
...
flags.DEFINE_string("init_checkpoint", default=model_dir + 'xlnet_model.ckpt',
      help="checkpoint path for initializing the model. "
      "Could be a pretrained model or a finetuned model.")
flags.DEFINE_string("output_dir", default="output",
      help="Output dir for TF records.")
flags.DEFINE_string("spiece_model_file", default=model_dir + 'spiece.model',
      help="Sentence Piece model path.")
flags.DEFINE_string("model_dir", default="saved_model",
