...
@File    :   component_xlnet_data_processor.py
...
def file_based_convert_examples_to_features(path, max_seq_length, tokenize_fn):
    '''
    ...
    :return:
    '''
    # output_file = './data/dev.tf_record'
    # tf.logging.info("Create new tfrecord {}.".format(output_file))
    writer = tf.python_io.TFRecordWriter('dev.tf_record_150')
    ...
    for index, row in df.iterrows():
        ...
        label = row[config["column_name_y"]]
...
label2id = {"时尚": 0, "体育": 1, "财经": 2, "科技": 3, "教育": 4, "娱乐": 5, "房产": 6, "家居": 7, "时政": 8, "游戏": 9}
config = {
    "spiece_model_file": "/home/xsq/model/chinese_xlnet_mid_L-24_H-768_A-12/spiece.model",
    "train_file": "/home/xsq/nlp_code/xlnet-tutorial/data/dev.csv",
    "tf_record_file": " ",
    "column_name_x1": "text1",
    "column_name_x2": "",
    "column_name_y": "label",
    "max_seq_len": 150,
}
...
file_based_convert_examples_to_features(config["train_file"], label2id, config["max_seq_len"], tokenize_fn)
